  ...
  export function rebuildModules(actor) {
    ...
    switch(actor.system.biodata.size){
      ...
      case 4://large
        ...
        baseTrait.system.description = "Large creatures gain a +1 Strength and Block while having a -1 penalty to Stealth, Acrobatics and Dodge.They must consume 4 Meals per day to qualify for the benefits from a Full Rest. Additionally, they take up double the space of a normal creature but have an increased carrying capacity.";
        break;
    }
