...
function getNameByID(uuid) {
    switch(uuid) {
        ...
        case "40241984982e4ab7": return "Beast";
        case "31eaf6bb90aa4f8e": return "Humanoid";
        case "5425347202be4d88": return "Elemental";
        case "b28d9a110e8d43a9": return "Undead";
        case "ab256a1087394e86": return "Plantoid";
        case "49478ac7e48d4c00": return "Construct";
        case "fe00cf0d699641cc": return "Fey";
